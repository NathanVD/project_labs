        ...
        <div class="card-body">
          ...
          <div class="row">
            <div class="col">
              <div class="form-group">
                ...
                <input name="lieu" id="lieu" value="{{$map ? $map->name : 'Bureau'}}" class="form-control{{($errors->isNotEmpty() ? $errors->first('lieu') ? " is-invalid" : " is-valid" : "")}}">
              </div>              
            </div>
            <div class="col">
          ...
          <div class="form-group">
            ...
            <input name="url" id="url"
             ...
             class="form-control{{($errors->isNotEmpty() ? $errors->first('url') ? " is-invalid" : " is-valid" : "")}}">
          </div>
