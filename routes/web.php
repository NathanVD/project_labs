...
Route::get('/blog_post/{id}', 'BlogpageController@show')->name('blog_post');
Route::get('/blog_search/title', 'BlogpageController@search')->name('blog_search');
Route::get('/blog_search/category/{category}', 'BlogpageController@cat_search')->name('cat_search');
Route::get('/blog_search/tag/{tag}', 'BlogpageController@tag_search')->name('tag_search');
Route::get('/blog_search/author/{author}', 'BlogpageController@author_search')->name('author_search');
